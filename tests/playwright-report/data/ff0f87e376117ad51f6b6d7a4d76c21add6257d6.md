...
- main:
  ...
  - button:
    - img
  - progressbar
  - text: "[3:08:19 PM] Création de l'investigation... Investigations actives"
...
- dialog "Unhandled Runtime Error":
  ...
  - heading "settle" [level=3]
  - link "webpack-internal:/node_modules/axios/lib/core/settle.js (19:1)":
    - text: webpack-internal:/node_modules/axios/lib/core/settle.js (19:1)
    - img
  - heading "XMLHttpRequest.onloadend" [level=3]
  - link "webpack-internal:/node_modules/axios/lib/adapters/xhr.js (59:13)":
    - text: webpack-internal:/node_modules/axios/lib/adapters/xhr.js (59:13)
    - img
```